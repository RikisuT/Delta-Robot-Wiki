...
export default function App() {
  ...
  return (
    <div className="h-screen w-full bg-slate-950 font-sans text-slate-200 overflow-hidden relative flex flex-col">
      {/* Tab Navigation */}
      <div className="h-14 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border-b border-slate-700/50 flex items-center px-6 gap-2 flex-shrink-0 z-40 backdrop-blur-xl">
      ...
      <div 
        ref={containerRef} 
        className="flex-1 absolute inset-0 top-14 bg-slate-900 select-none"
